        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('jadwalmapel.update', $jadwalmapel->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                           ...
                           <div class="form-group">
                                ...
                                @foreach ($gurutb as $guru)
                                    @if (old('namaguru_id', $jadwalmapel->namaguru_id == $guru->id) )
                                        <option value="{{$guru->namaguru }}" selected>{{ $guru->namaguru }}</option>  
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('jammasuk') is-invalid @enderror" name="jammasuk" value="{{ old('jammasuk', $jadwalmapel->jammasuk) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('jamkeluar') is-invalid @enderror" name="jamkeluar" value="{{ old('jamkeluar', $jadwalmapel->jamkeluar) }}">
                            ...
                            <button type="submit" class="btn btn-md btn-primary"><i class="fas fa-edit"> Edit</i></button>
                             <a href="{{ route('jadwalmapel.index') }}" class="btn btn-md btn-success"><i class="fas fa-backspace"> Kembali</i></a>
                        </form> 
                    </div>
                </div>
            </div>
