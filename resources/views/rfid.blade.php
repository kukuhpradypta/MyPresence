...
<body>
    <x-guest-layout>
        <div class="grid grid-cols-2">
            <div style="background-image: url({{ asset('foto/rfid.png') }});background-repeat:no-repeat;background-size:cover;background-attachment: fixed;
    background-position:10% 45%;background-position-x: -230px; ">
